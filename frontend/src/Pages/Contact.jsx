            ...
            <form class="p-6 flex flex-col justify-center">
              <div class="flex flex-col">
                ...
                <input
                  ...
                  class="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none dark:text-gray-300"
                />
              </div>
              ...
              <div class="flex flex-col mt-2">
                ...
                {/* <input
                  ...
                  /> */}
                <textarea
                  className="textarea textarea-bordered w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-indigo-500 focus:outline-none min-h-[110px] dark:text-gray-300"
